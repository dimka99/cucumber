package Def_CreateAzureVirtualServerWindows;
...
public class Def_CreateAzureVirtualServerWindows {
	...
	public void fill_virtual_server_form_and_click_submit_button() throws Throwable {
		...
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		ServerName="azurewindows-"+Utils.CommonScripts.GetDateTime();
		...
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		PageObjects.CreateVirtualServerPage.txt_BusinessPurpose(driver).sendKeys("azurewindows-"+Utils.CommonScripts.GetDateTime());
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));

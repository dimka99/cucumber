...
public class Def_CreateGoogleVirtualServerWindows {
	...
	public void fill_virtual_server_form_and_click_submit_button() throws Throwable {
		...
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		PageObjects.CreateVirtualServerPage.SelectDataCenter(driver, "Google");
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		...
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		PageObjects.CreateVirtualServerPage.txt_BusinessPurpose(driver).sendKeys("googlewindows-"+Utils.CommonScripts.GetDateTime());
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		...
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));		
		PageObjects.CreateVirtualServerPage.txt_NodeName(driver).sendKeys("googlewindows-"+Utils.CommonScripts.GetDateTime());
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		PageObjects.CreateVirtualServerPage.SelectComputeProfile(driver, "Small");
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		PageObjects.CreateVirtualServerPage.SelectImage(driver, "Win");
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		PageObjects.CreateVirtualServerPage.SelectVirtualNetwork(driver, "vpc");
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		//PageObjects.CreateVirtualServerPage.SelectSubnet(driver, "vpc");
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		...
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		PageObjects.CreateVirtualServerPage.SelectAvailabilityGroup(driver, "us");
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		...
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
		//PageObjects.CreateVirtualServerPage.txt_cloudID(driver).sendKeys("google-"+Utils.CommonScripts.GetDateTime());
		wait.until(ExpectedConditions.invisibilityOf(PageObjects.BucketResourcePage.div_loading(driver)));
